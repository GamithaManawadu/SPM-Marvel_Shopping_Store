...
export class UploadProductPage extends Component {
    ...
    handleChangeCatergories = (event) => {
        this.setState({ Catergories: event.currentTarget.value })
    }
    ...
    onSubmit = (event) => {
        ...
        if (!this.state.title || !this.state.description ||
            !this.state.catergories || !this.state.images
            || !this.state.price) {
        ...
        return (
            ...
            <Form onSubmit={this.onSubmit}>
               ...
               <FileUpload refreshFunction={this.updateFiles} />
                ...
                />
                <br /><br />
                <select onChange={this.handleChangeCatergories}>
