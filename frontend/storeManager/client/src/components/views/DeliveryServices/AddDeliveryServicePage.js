...
import '../DeliveryServices/DeliveryService.css';
...
class AddDeliveryServiceForm extends Component {
  ...
  onSubmit = async (e) => {
	  ...
	  await axios.post(`http://localhost:5000/api/deliveryservice/add`, deliveryservice)
      .then(response => {
		  console.log("Data successfully inserted");
		//   window.location.reload(false);
		  this.props.history.push('/delivery/deliveryservices');
  ...
  render() {
	...
	return (
		<div className="deliveryserviceContent">
			<ToastContainer
				position="top-center"
				autoClose={3000}
				hideProgressBar
